...
### Changed
  ...
  * core: Raise minimum supported Rust version (MSRV) to 1.91.0.
...
### Changed
  ...
  * core: Raise minimum supported Rust version (MSRV) to 1.88.0.

## 0.18.0 - 2025-07-12

### Changed

  * core: Raise minimum supported Rust version (MSRV) to 1.85.0.
