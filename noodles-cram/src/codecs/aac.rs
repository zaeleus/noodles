...
mod tests {
    ...
    #[test]
    fn test_arith_decode_order_0() -> io::Result<()> {
        let data = [
            0x00, // flags = {empty}
        ...
        let mut reader = &data[..];
        assert_eq!(arith_decode(&mut reader, 0)?, b"noodles");

        Ok(())
    }

    #[test]
    fn test_arith_decode_order_1() -> io::Result<()> {
        let data = [
            0x01, // flags = ORDER
            0x07, // uncompressed len = 7
    ...
    #[test]
    fn test_arith_decode_stripe() -> io::Result<()> {
        let data = [
            0x08, // flags = STRIPE
            0x07, // uncompressed len = 7
    ...
    #[test]
    fn test_arith_decode_uncompressed() -> io::Result<()> {
        let data = [
            0x20, // flags = CAT
            0x07, // uncompressed len = 7
    ...
    #[test]
    fn test_arith_decode_rle_with_order_0() -> io::Result<()> {
        let data = [
            0x40, // flags = RLE
        ...
        let mut reader = &data[..];
        assert_eq!(arith_decode(&mut reader, 0)?, b"noooooooodles");

        Ok(())
    }

    #[test]
    fn test_arith_decode_rle_with_order_1() -> io::Result<()> {
        let data = [
    ...
    #[test]
    fn test_arith_decode_bit_packing_with_6_symbols() -> io::Result<()> {
        let data = [
            0x80, // flags = PACK
            0x07, // uncompressed len = 7
