...
mod tests {
    ...
    fn build_record() -> Record {
        Record::from(vec![
            // ref_id
            0x0a, 0x00, 0x00, 0x00, // pos
            0x85, 0xee, 0x00, 0x00, // l_read_name
            0x0a, // mapq
            0x0c, // bin
            0x4c, 0x12, // n_ciar_op
            0x01, 0x00, // flag
            0xa3, 0x00, // l_seq
            0x04, 0x00, 0x00, 0x00, // next_ref_id
            0x0a, 0x00, 0x00, 0x00, // next_pos
            0xe0, 0xee, 0x00, 0x00, // tlen
            0xa6, 0x00, 0x00, 0x00, // read_name
            0x6e, 0x6f, 0x6f, 0x64, 0x6c, 0x65, 0x73, 0x3a, 0x30, 0x00, // cigar
            0x40, 0x00, 0x00, 0x00, // seq
            0x18, 0x42, // qual
            0x1f, 0x1d, 0x1e, 0x20, // data
